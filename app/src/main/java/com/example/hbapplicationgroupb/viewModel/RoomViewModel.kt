...
//            if (response.isSuccessful) {
//                val responseBody = response.body()
//                _topHotel.postValue(Resource.Success(responseBody))
//            } else {
//                _topHotel.postValue(Resource.Error(response.message()))
//            }
//        }else{
//            _topHotel.postValue(Resource.Error("No Internet Connection"))
//        }
//
//    } catch (e: Throwable) {
//        when(e) {
//            is IOException -> _topHotel.postValue(Resource.Error("Network Failure"))
//            else -> _topHotel.postValue(Resource.Error("An error occurred"))
//        }
//    }
//
//}
